...
//    [SerializeField]
        ...
        void Update()
        {
            ...
            UnityEngine.Debug.DrawRay(startPos, endPos, Color.aliceBlue);
            RaycastHit hit;
            if (UnityEngine.Physics.Raycast(startPos, endPos, out hit, _interactionDistanceMax, _interactableLayerMask))
            {
                UnityEngine.Debug.Log($"${hit.collider.gameObject.name} ${hit.distance}, ${_interactionDistanceMax}");
